...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, max_seq_len: int, d_model: int):
        ...
        pe_2i = torch.sin(pos / 10000 ** (two_i / d_model))  # 对序列中的各个单词（元素）在各个维度上进行编码
        pe_2i_1 = torch.cos(pos / 10000 ** (two_i / d_model))
        # 交错拼接 [sin0,cos0,sin1,cos1,…]，因为stack时进行了打包配对处理
    ...
    def forward(self, t):
        return self.embedding(t)  # 从预先计算好的结果中直接索引，提高计算效率
